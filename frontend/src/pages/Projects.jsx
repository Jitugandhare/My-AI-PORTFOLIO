                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                A full-stack Inst-Fista - Social Application built with the MERN stack, featuring secure authentication, customizable profiles, and real-time chat. 
                                Optimized APIs and MongoDB queries ensure fast, scalable performance.
                            </p>
                            <div className="flex justify-between items-center">
                                <div className="flex space-x-2">
                                    <button
                                        ...
                                        onClick={() =>
                                            askProjectQuestion(
                                                "Tell me more about the Insta-Fista - Social Application project"
                                            )
                                        }
                                    >
                                        View Details
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            askProjectQuestion(
                                                "What technologies were used in the Insta-Fista - Social Application project?"
                                            )
                                        }
                                    >
                                        Technologies
