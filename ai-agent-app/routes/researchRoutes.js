...
// POST /api/research
researchRoute.post('/', async (req, res) => {
    try {
...
researchRoute.get('/trends', async (req, res) => {
    try {
...
researchRoute.post('/technology', async (req, res) => {
    try {
...
researchRoute.post('/compare', async (req, res) => {
    try {
...
researchRoute.post('/search', async (req, res) => {
    try {
