...
clientRoute.get('/services', async (req, res) => {
    try {
...
clientRoute.get('/services/:serviceId', async (req, res) => {
    try {
...
clientRoute.get('/process', async (req, res) => {
    try {
...
clientRoute.post('/proposal', async (req, res) => {
    try {
